...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void setUp() {
		...
		i.putExtra(PickSet.currentSet, act.getResources().getStringArray(R.array.nonlivingthingshard));
		
		act.setIntent(i);  //later MainActivity calls to getIntent will return this (we need this to test voice recognition results)
		*/
	...
	public void testHintReset() {
		...
		assertEquals("hints used after all hints clicked", 3, act._numHintsUsed);
